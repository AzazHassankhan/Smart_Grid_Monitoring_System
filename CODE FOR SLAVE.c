...
unsigned char adc3()          //ANALOG TO DIGITAL CONVERTION OF TEMPRATURE SENSOR FUNCTION
 ...
 void condition1(unsigned char var)                 //CONDITIONS FOR VOLTAGE SENSOR
 {  
 ...
 void condition2(unsigned char var)              //CONDITIONS FOR PRESSURE SENSOR
{     unsigned char unite,tenth;
      tenth=var/10;                              //RECEIVING DATA AND EXTRACTING TENTH DIGIT
	...
	TimerDelay();TimerDelay();
       ...
       unite=var%10;                               //RECEIVING DATA AND EXTRACTING UNITE DIGIT
...
void condition3(unsigned char var)                 //CONDITIONS FOR TEMPRATURE SENSOR
{unsigned char unite,tenth;
       var=var*1.966;                                 //FORMULA FOR TEMPRATURE SENSOR
       tenth=var/10;  
       tenth=tenth+0x30;
       SBUF=tenth;
       while(TI==0);
...
{unsigned char tenth;
       var=var*2;                                 //FORMULA FOR TEMPRATURE SENSOR
       tenth=var/10;  
        if (tenth>3)
				{motor=1;}
				else
